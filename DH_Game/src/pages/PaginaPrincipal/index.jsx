        ...
        <main>
            ...
            <section>
                ...
                <ul>
                    {
                        newGames.map(game => (
                            <ComponenteCardRetangular gamesItens = {game}/>
                        ))
                    }
                </ul>
            </section>
                ...
                <ul className="grid_list">
                    {
                        halloweenGames.map(hallGame => (
                            <ComponenteCardQuadrado gamesItens = {hallGame}/>
                        ))
                    }
                </ul>
            </section>
                ...
                <ul>
                    {
                        earlyAccessGames.map(accessGame => (
                            <ComponenteCardRetangular gamesItens = {accessGame}/>
                        ))
                    }
                </ul>
            </section>
                ...
                <ul className="grid_list">
                    {
                        cheapGames.map(cheapGame => (
                            <ComponenteCardQuadrado gamesItens = {cheapGame}/>
                        ))
                    }
                </ul>
            </section>
